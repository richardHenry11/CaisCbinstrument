...
class OfficeAbsence extends StatefulWidget {
  const OfficeAbsence({super.key});

  @override
  State<OfficeAbsence> createState() => _OfficeAbsenceState();
}
...
class _OfficeAbsenceState extends State<OfficeAbsence> {
  String? _savedUser;
  String? _savedToken;
  // String? _isLoggedIn;
  String? _savedName;
  ...
  await _clearWorkTypePrefs();
  await _prefsCatcher();
  _initLocation();
}

  Future<void> _clearWorkTypePrefs() async {
  ...
  Future<void> _initLocation() async {
    ...
    positionStream = Geolocator.getPositionStream(
      ...
      setState(() {
        ...
        activeOffice = matchedOffice;
        distance = nearestDistance;
        _canPressButton = matchedOffice != null;
                  ...
                  child: Card(
                    ...
                    Column(
                      ...
                      children: [
                          ...
                          Column(
                            children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _canPressButton ? Colors.green : Colors.red,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(
                                            _canPressButton ? Icons.check_circle : Icons.cancel,
                                            size: 10,
                                            color: Colors.white,
                                          ),
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceAround,
                                children: [
                                  Text("Lat:", style: TextStyle(color: Colors.white, fontSize: 12),),
                                  Text("Long:", style: TextStyle(color: Colors.white, fontSize: 12))
                                ],
                              ),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: [
                                    Text("$officeLatKip, ", style: TextStyle(color: const Color.fromARGB(255, 111, 255, 116), fontSize: 12,),),
                                    Text("$officeLngKip", style: TextStyle(color: const Color.fromARGB(255, 107, 255, 112), fontSize: 12),)
                                ],
                              ),
                              SizedBox(
                              ...
                              child: ClipRRect(
                                ...
                                child: FlutterMap(
                                  options: MapOptions(
                                    initialCenter: activeOffice?.location ?? offices.first.location,
                                    initialZoom: 15,
                                  ...
                                  children: [
                                    ...
                                    MarkerLayer(
                                      markers: [
                                        ...offices.map((office) => Marker(
                                          point: office.location,
                                          width: 40,
                                          height: 40,
                                          child: Icon(
                                            Icons.location_city,
                                            color: activeOffice?.id == office.id
                                                ? Colors.green
                                                : Colors.blue,
                                            size: 36,
                                          ),
                        ...
                        //       ),
                        //     ),
                        //     onPressed: _canPressButton && _isShiftSelected
                        //         ? () {
                        //             Navigator.push(
                        //               context,
