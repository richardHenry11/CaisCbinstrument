...
class _GoodInputListState extends State<GoodInputList> {
  ...
  Future<List<Map<String, dynamic>>> _fetchData(int page) async {
    try {
      ...
      final url =
          "https://cais.cbinstrument.com/auth/inventory/barang-masuk?page=$page&per_page=$_perPage";
  ...
  void _applyFilter() {
    ...
    setState(() {
      _filteredData = _apiTresholder.where((item) {
        ...
        final matchSearch =
            search.isEmpty || nama.contains(search) || qr.contains(search);
        ...
        // // if (endDateTime != null) {
        // //   final endOfDay = endDateTime!.add(Duration(days: 1));
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(color: Color(0xFF6ee7b7), fontSize: 15),
                  ),
                ),
              ],
            ),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          EditGoodInput(barang: _apiTresholder[index]),
                    ),
                  );
                },
                child: Row(
