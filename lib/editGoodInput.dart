...
class EditGoodInput extends StatefulWidget {

  final Map<String, dynamic> barang;

  const EditGoodInput({super.key,required this.barang});

  @override
  State<EditGoodInput> createState() => _EditGoodInputState();
}

class _EditGoodInputState extends State<EditGoodInput> {
  //===================== global funct here!! ===========================
  ...
  void initState() {
    ...
    _jumlah.text = widget.barang["jumlah"].toString();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Ubah Barang Masuk", style: TextStyle(color: Color(0xFF4a9eff)),),
      ),
                ...
                child: SizedBox(
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(t.translate(""), style: TextStyle(color: AppTheme.textSecondary(context))),
                        TextFormField(
                          style: TextStyle(color: AppTheme.textSecondary(context)),
