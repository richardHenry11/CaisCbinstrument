...
class InputGoodsInput extends StatefulWidget {
  ...
  const InputGoodsInput({super.key,required this.barang});

  @override
  State<InputGoodsInput> createState() => _InputGoodsInputState();
}

class _InputGoodsInputState extends State<InputGoodsInput> {
  //===================== global funct here!! ===========================
