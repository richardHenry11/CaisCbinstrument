...
//             child: Image.network(
//               "https://cais.cbinstrument.com/${item['gambar']}",
...
//                   side: BorderSide(width: 1, color: Color(0xFF047857)),
//                 ),
//                 onPressed: () {
//                   // button funct here!!!
//                   Navigator.push(
...
//                     MaterialPageRoute(
//                       builder: (context) =>
//                           InputGoodsInput(barang: _apiTresholder[index]),
//                     ),
//                   );
//                 },
//                 child: Row(
...
//                   side: BorderSide(width: 1, color: Color(0xFF991b1b)),
//                 ),
//                 onPressed: () {
//                   // button funct here!!!
//                   Navigator.push(
...
//                     MaterialPageRoute(
//                       builder: (context) =>
//                           InputGoodsOutput(barang: _apiTresholder[index]),
//                     ),
//                   );
//                 },
//                 child: Row(
...
//                     MaterialPageRoute(
//                       builder: (context) =>
//                           EditGood(barang: _apiTresholder[index]),
//                     ),
//                   );
//                 },
//                 child: Row(
...
//     final responseAPI = await http.delete(Uri.parse(url), headers: headers);
...
//                                   Text(
//                                     "Belum ada Barang",
//                                     style: TextStyle(color: const Color.fromARGB(255, 159, 159, 159), fontSize: 20),
//                                   ),
//                                   Text(
//                                     "Klik tombol 'Tambah Barang' untuk memulai",
//                                     style: TextStyle(color: const Color.fromARGB(255, 159, 159, 159), fontSize: 15),
//                                   ),
//                                 ],
//                               ),
//                             )
