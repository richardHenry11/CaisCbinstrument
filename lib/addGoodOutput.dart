...
class Addgoodoutput extends StatefulWidget {

  const Addgoodoutput({super.key,required});

  @override
  State<Addgoodoutput> createState() => _AddgoodoutputState();
}

class _AddgoodoutputState extends State<Addgoodoutput> {
  //===================== global funct here!! ===========================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Tambah Barang Keluar", style: TextStyle(color: Color(0xFFfca5a5)),),
      ),
