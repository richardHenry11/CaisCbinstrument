...
class Addgoodinput extends StatefulWidget {
  ...
  const Addgoodinput({super.key,required});

  @override
  State<Addgoodinput> createState() => _AddgoodinputState();
}

class _AddgoodinputState extends State<Addgoodinput> {
  //===================== global funct here!! ===========================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Tambah Barang Masuk", style: TextStyle(color: Color(0xFF4a9eff)),),
      ),
