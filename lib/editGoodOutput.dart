...
class EditGoodOutput extends StatefulWidget {
  ...
  const EditGoodOutput({super.key,required this.barang});

  @override
  State<EditGoodOutput> createState() => _EditGoodOutputState();
}

class _EditGoodOutputState extends State<EditGoodOutput> {
  //===================== global funct here!! ===========================
