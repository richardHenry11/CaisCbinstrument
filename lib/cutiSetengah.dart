...
class CutiSetengah extends StatefulWidget {
  const CutiSetengah({super.key});

  @override
  State<CutiSetengah> createState() => _CutiSetengahState();
}

class _CutiSetengahState extends State<CutiSetengah> {
  String? _savedUser;
  String? _savedToken;
  // String? _isLoggedIn;
  String? _savedName;
